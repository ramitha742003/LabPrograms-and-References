...
df = pd.read_csv(r"C:/Users/ramit/OneDrive/Desktop/Ramitha/MCA/ML/pima_indian.csv")
...
sns.heatmap(metrics.confusion_matrix(ytest, predicted), annot=True, fmt='d', cmap='Blues')
